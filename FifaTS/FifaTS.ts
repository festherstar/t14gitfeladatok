...
function AtlagFelettiek(vizsgaltTomb: any[]): any{
...
function LegtobbetJavitoIndexKiir(csapatIndex: number){
...
function SzerepelEMagyarorszagKiir(vizsgalatEredmenye: boolean): void{
...
function ValtozasMennyisegek(vizsgaltTomb: any, valtozasTipusok: any): any{
...
function StatisztikaKiirTABLAZAT(valtozasok: any,mennyisegek: any){
